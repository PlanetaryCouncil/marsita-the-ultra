...
The signal is here…
الإشارة هنا…			// The signal is here…

[Verse 1 — Hebrew core]

עוד יום עובר, אותו סיפור	// Another day passes, the same story
לב נשבר בכל אזור			// Hearts break in every region
אבל עמוק יש קול אחדים		// But deep down there is one voice
שאומר — כולנו לב אחדים		// That says — we are all one heart

[Pre-Chorus — lift]

אם יש משהו מעל כולם			// If there is something above all
הוא לא בוחר רק בן אחדים		// He doesn't choose just one person
אז למה אנחנו נפרדים			// Then why do we separate
אם בפנים אנחנו אחדים		// If inside we are one

[Chorus — multilingual, viral]

🌍 שלום, סלאם — one world, one heart 	// Hello, Salam
לב אל לב — nunca más la guerra			// Heart to heart
עזה, תל אביב — אותו כאב					// Gaza, Tel Aviv — the same pain
Habibi, habibi — amor para todos

[Drop — ultra simple loop]
...
[Verse 2 — Hebrew + light mix]

לא ימין, לא שמאל, לא הם ולא אנחנו	// Not right, not left, not them, not us.
Todos somos uno — זה מה ששכחנו		// This is what we forgot.
פחד נעלם כשפותחים את הלב			// Fear disappears when you open your heart.
Y el amor — זה הקוד שמתחבר			// This is the code that connects

[Bridge — awakening]

המשיח החדש לא בא מבחוץ				// The new Messiah does not come from outside.
ليس شخص — זה ניצוץ בפנים			// Not a person — it's a spark inside
No savior coming down from above
זה אתה שמתעורר — זה אהבה			// It is you who awakens — it is love.

[Break — minimal, strong]
